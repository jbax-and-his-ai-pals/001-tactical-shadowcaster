...
ITEM_CATALOG: dict[str, dict] = {
    ...
    "haste_draught": {
        ...
        "family": "tincture",
        "rarity": "uncommon",
        "effects": [{"type": "haste", "turns": 6}],
        "color": (140, 220, 180),
        "marker": "power",
        "description": "Grants haste for 6 turns — move twice as far per step.",
        "biomes": ["plains", "farmland", "dungeon"],
        "buy_price": 0,
        "sell_price": 12,
    },
    "battle_brew": {
        ...
        "family": "tincture",
        "rarity": "uncommon",
        "effects": [{"type": "strength", "turns": 5}],
        "color": (220, 120, 60),
        "marker": "power",
        "description": "Grants strength for 5 turns — +3 melee damage.",
        "biomes": ["castle", "dungeon", "ruins", "badlands", "monster_town"],
        "buy_price": 0,
        "sell_price": 12,
    },
    "swiftness_vial": {
