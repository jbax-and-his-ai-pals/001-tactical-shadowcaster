...
def town_profile(context, hostile=False):
    ...
    profiles = {
        "hamlet": {"plaza_w": 11, "plaza_h": 7, "house_divisor": 430, "min_houses": 6, "service_cap": 2, "ponds": 0},
        "village": {"plaza_w": 13, "plaza_h": 9, "house_divisor": 340, "min_houses": 8, "service_cap": 3, "ponds": 1},
        "town": {"plaza_w": 15, "plaza_h": 9, "house_divisor": 280, "min_houses": 10, "service_cap": 4, "ponds": 1},
        "large_town": {"plaza_w": 17, "plaza_h": 11, "house_divisor": 230, "min_houses": 12, "service_cap": 5, "ponds": 2},
    }
    biome_decor = {
